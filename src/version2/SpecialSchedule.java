...
public class SpecialSchedule {
	...
	private void make02102015() {
		Day temp = new Day();
		temp.setDayType('F');
		Period p = new Period();
		p.setStartTime(adjustTime(800, today, 1));
		p.setEndTime(adjustTime(800, today, 1));
		p.setNumber(6);
		temp.add(p);
		p = new Period();
		p.setStartTime(adjustTime(905, today, 1));
	...
	private void makeBTSN() {
		Day temp = new Day();
		temp.setDayType('E');
		Period p = new Period();
		p.setStartTime(adjustTime(1915, today, 1));
		p.setEndTime(adjustTime(1925, today, 1));
		p.setNumber(ADVISORY);
		temp.add(p);
		p = new Period();
		p.setStartTime(adjustTime(1930, today, 1));
		p.setEndTime(adjustTime(1940, today, 1));
		p.setNumber(1);
		temp.add(p);
		p = new Period();
		p.setStartTime(adjustTime(1945, today, 1));
		p.setEndTime(adjustTime(1955, today, 1));
		p.setNumber(2);
		temp.add(p);
		p = new Period();
		p.setStartTime(adjustTime(2000, today, 1));
		p.setEndTime(adjustTime(2010, today, 1));
		p.setNumber(3);
		temp.add(p);
		p = new Period();
		p.setStartTime(adjustTime(2015, today, 1));
		p.setEndTime(adjustTime(2025, today, 1));
		p.setNumber(4);
		temp.add(p);
		p = new Period();
		p.setStartTime(adjustTime(2030, today, 1));
		p.setEndTime(adjustTime(2040, today, 1));
		p.setNumber(5);
		temp.add(p);
		p = new Period();
		p.setStartTime(adjustTime(2045, today, 1));
		p.setEndTime(adjustTime(2055, today, 1));
		p.setNumber(6);
		temp.add(p);
		p = new Period();
		p.setStartTime(adjustTime(2100, today, 1));
		p.setEndTime(adjustTime(2110, today, 1));
		p.setNumber(7);
		temp.add(p);
		specialDay = temp;
	}

	private void make10122015() {
		Day temp = new Day();
		temp.setDayType('E');
		Period p = new Period();
		p.setStartTime(adjustTime(900, today, 1));
	...
	private void make05272016() {
		...
		temp.add(p);
		p = new Period();
		p.setStartTime(adjustTime(1025, today, 1));
		p.setEndTime(adjustTime(1035, today, 1));
		p.setNumber(BREAK);
		temp.add(p);
		p = new Period();
		p.setStartTime(adjustTime(1035, today, 1));
		p.setEndTime(adjustTime(1120, today, 1));
		p.setNumber(4);
		temp.add(p);
		p = new Period();
